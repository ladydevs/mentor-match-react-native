...
A React Native app built on the [react-native-rockstarter](https://github.com/codehangar/react-native-rockstarter) boilerplate from Code Hangar for getting started with react native
